...
CREATE TABLE IF NOT EXISTS `Taller_0`.`Persona` (
  ...
  `edad` INT NOT NULL,
  `telefono` BIGINT(10) ZEROFILL NULL DEFAULT 0,
  `sexo` TINYINT NULL,
  `vivienda` INT NULL,
...
-- -----------------------------------------------------
-- Table `Taller_0`.`Propietarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Taller_0`.`Propietarios` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE INDEX `fk_Persona_has_Vivienda_Vivienda1_idx` ON `Taller_0`.`Propietarios` (`Vivienda_id` ASC) VISIBLE;

CREATE INDEX `fk_Persona_has_Vivienda_Persona_idx` ON `Taller_0`.`Propietarios` (`Persona_id` ASC) VISIBLE;
